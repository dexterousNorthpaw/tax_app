...
class IntlAuthScreen2 extends StatefulWidget {
  const IntlAuthScreen2({super.key});

  @override
  State<IntlAuthScreen2> createState() => _IntlAuthScreen2State();
}

class _IntlAuthScreen2State extends State<IntlAuthScreen2> {
  @override
